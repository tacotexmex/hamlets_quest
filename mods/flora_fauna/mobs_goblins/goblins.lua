--[[
       Goblins' spawn ranges by Hamlet
       These values have been chosen for dfcaverns' biomes
--]]

-- Name: goblin_cobble; variables: gCob_min, gCob_max

local gCob_min = -2700
local gCob_max = -300

-- Name: goblin_digger; variables: gDig_min, gDig_max

local gDig_min = -2700
local gDig_max = -300

-- Name: goblin_coal; variables: gCoa_min, gCoa_max

local gCoa_min = -2700
local gCoa_max = -300

-- Name: goblin_iron; variables: gIro_min, gIro_max

local gIro_min = -2700
local gIro_max = -320

-- Name: goblin_copper; variables: gCop_min, gCop_max

local gCop_min = -2700
local gCop_max = -320

-- Name: goblin_gold; variables: gGol_min, gGol_max

local gGol_min = -2700
local gGol_max = -340

-- Name: goblin_diamond; variables: gDia_min, gDia_max

local gDia_min = -2700
local gDia_max = -380

-- Name: goblin_king; variables: gKin_min, gKin_max
...
-- Modified by Hamlet
mobs_goblins:spawn_specific("mobs_goblins:goblin_cobble", {"group:stone"}, "air", 0, 50, 1, 10, 3, gCob_min , gCob_max)
mobs_goblins:spawn_specific("mobs_goblins:goblin_digger", {"group:stone"},  "air", 0, 50, 1, 10, 3, gDig_min , gDig_max)
mobs_goblins:spawn_specific("mobs_goblins:goblin_coal", {"default:stone_with_coal", "default:mossycobble"}, "air",0, 50, 1, 2, 3, gCoa_min, gCoa_max)
mobs_goblins:spawn_specific("mobs_goblins:goblin_iron", {"default:stone_with_iron", "default:mossycobble"}, "air", 0, 50, 1, 2, 3, gIro_min, gIro_max)
mobs_goblins:spawn_specific("mobs_goblins:goblin_copper", {"default:stone_with_copper", "default:mossycobble"}, "air", 0, 50, 1, 2, 3, gCop_min, gCop_max)
mobs_goblins:spawn_specific("mobs_goblins:goblin_gold", {"default:stone_with_gold", "default:mossycobble"}, "air",0, 50, 1, 2, 3, gGol_min, gGol_max)
mobs_goblins:spawn_specific("mobs_goblins:goblin_diamond", {"default:stone_with_diamond", "default:mossycobble" }, "air", 0, 50, 1,2, 3, gDia_min, gDia_max)
mobs_goblins:spawn_specific("mobs_goblins:goblin_king", {"default:mossycobble",},"air", 0, 50, 1, 10, 3, gKin_min, gKin_max)
mobs_goblins:register_egg("mobs_goblins:goblin_cobble", "goblin egg", "default:mossycobble", 1)
